<cfoutput>
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<p><a href="http://www.CompKnowHow.com" target="_blank" title="Your ColdBox and ContentBox specialists.">
				<div class="center">
					<img src="#event.getModuleRoot('contentbox-membersection')#/includes/images/logo.png" alt="Computer Know How, LLC" border="0" />
				</div>
			</a></p>
