/**
********************************************************************************
Copyright 2017 Member Section by Computer Know How, LLC
www.compknowhow.com
********************************************************************************

Author:  Computer Know How, LLC
Description:  Intercepts member section and processes as an admin event
*/
component extends="coldbox.system.Interceptor"{
	...
	*/
	function preProcess( event, interceptData, rc, prc ) eventPattern="^contentbox-membersection" {
